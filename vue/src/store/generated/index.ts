...
import TxlabsBlocklessChainTxlabsBlocklesschainMarket from './txlabs/blockless-chain/txlabs.blocklesschain.market'
import TxlabsBlocklessChainTxlabsBlocklesschainOrder from './txlabs/blockless-chain/txlabs.blocklesschain.order'
...
export default { 
  ...
  TxlabsBlocklessChainTxlabsBlocklesschainMarket: load(TxlabsBlocklessChainTxlabsBlocklesschainMarket, 'txlabs.blocklesschain.market'),
  TxlabsBlocklessChainTxlabsBlocklesschainOrder: load(TxlabsBlocklessChainTxlabsBlocklesschainOrder, 'txlabs.blocklesschain.order'),
