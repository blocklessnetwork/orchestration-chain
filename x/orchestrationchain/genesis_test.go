package orchestrationchain_test
...
import (
	...
	"github.com/blocklessnetwork/orchestration-chain/x/orchestrationchain"
...
func TestGenesis(t *testing.T) {
	...
	orchestrationchain.InitGenesis(ctx, *k, genesisState)
	got := orchestrationchain.ExportGenesis(ctx, *k)
