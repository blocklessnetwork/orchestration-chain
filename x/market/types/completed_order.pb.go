...
type CompletedOrder struct {
	...
	ResponseId  string `protobuf:"bytes,7,opt,name=responseId,proto3" json:"responseId,omitempty"`
}
...
func (m *CompletedOrder) GetResponseId() string {
	if m != nil {
		return m.ResponseId
	}
	return ""
...
var fileDescriptor_c9c5747e52889860 = []byte{
	...
	,
}
...
func (m *CompletedOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ResponseId) > 0 {
		...
		i = encodeVarintCompletedOrder(dAtA, i, uint64(len(m.ResponseId)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.FuelUsed) > 0 {
