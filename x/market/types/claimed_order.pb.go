...
func (m *ClaimedOrder) GetOrderIndex() string {
	if m != nil {
		return m.OrderIndex
	}
	return ""
...
var fileDescriptor_99afd8324f4fb72e = []byte{
	...
	,
}
...
func (m *ClaimedOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrderIndex) > 0 {
		...
		i = encodeVarintClaimedOrder(dAtA, i, uint64(len(m.OrderIndex)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
