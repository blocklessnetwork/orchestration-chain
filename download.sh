...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/blocklessnetwork/orchestration-chain/releases/download/latest/blockless-chain_latest_darwin_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_arm64")
		URL="https://github.com/blocklessnetwork/orchestration-chain/releases/download/latest/blockless-chain_latest_darwin_amd64.tar.gz"
		...
		;;
	"linux_amd64")
		URL="https://github.com/blocklessnetwork/orchestration-chain/releases/download/latest/blockchain_latest_linux_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm64")
		URL="https://github.com/blocklessnetwork/orchestration-chain/releases/download/latest/blockchain_latest_linux_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
