...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	"darwin_arm64")
		...
		;;
	"linux_amd64")
		URL="https://github.com/txlabs/blockless-chain/releases/download/latest/blockless-chain_latest_linux_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm64")
		URL="https://github.com/txlabs/blockless-chain/releases/download/latest/blockless-chain_latest_linux_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
